...
- For 4 purposes, data set includes
  - Observations from 8525 patients of 407 doctors
  - Experience (Years of, measured at doctor level)
  - IL6, CRP, CancerStage, and LengthofStay (Measured at patient level)
  - Outcome variable of Remission, measured at patient level as 0 (not in remission) or 1 (in remission)
    - remission vs exacerbation
- Outputs
  - Random Intercept + Random Slope for Length of Stay

** Software Implementation
- SAS: PROC GLIMMIX
- SPSS: GLMM
- R: glmer (in the lme4 package), and others
- Stata: meglm
- C++: GPBoost (R and Python pacakge - gpboost)
- Python: statsmodels
  - [[https://towardsdatascience.com/generalized-linear-mixed-effects-models-in-r-and-python-with-gpboost-89297622820c][A blog for comparing GLMM modeling in R and Python]]
